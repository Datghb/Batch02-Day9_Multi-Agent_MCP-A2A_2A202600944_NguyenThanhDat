...
### 1. Đọc luồng xử lý
Mỗi file thể hiện một pattern cụ thể: tool calling hoặc multi-agent routing.

### 2. So sánh với Stages
Code trong `stages/*` là examples đầy đủ hơn để đối chiếu.
...
4. So sánh với code mẫu trong `stages/`
