...
Ví dụ hoàn chỉnh về privacy agent và conditional routing.
"""
...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia bảo vệ dữ liệu cá nhân và quyền riêng tư. Phân tích khía cạnh privacy trong câu hỏi:

Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR, data protection, privacy rights, data breach, nghĩa vụ thông báo, tiền phạt và biện pháp khắc phục."""
